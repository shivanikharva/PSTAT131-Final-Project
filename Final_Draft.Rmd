...
Our random forest actually performed better on the testing set than on the cross-validation folds with an RMSE of 37.87014! Since RMSE is measured in relation to the values the outcome may take on, our testing RMSE of 37.87014 in relation to the outcome range from 0 to 255 is not a great RMSE, but it is not too bad either. So, our model did not perform horribly and still managed to explain some variation in the outcome!  
