...
write_csv(pokemon, "pokemon_final.csv")
```
...
# RIDGE REGRESSION
ridge_tuned <- read_rds(file = "ridge.rds")

# LASSO REGRESSION
lasso_tuned <- read_rds(file = "lasso.rds")
...
# BOOSTED TREES
boosted_final_fit <- read_rds(file = "boosted_final.rds")
...
write_rds(rf_final_fit, file = "rf_final_train.rds")
```
...
pokemon_tibble <- predict(rf_final_fit, new_data = pokemon_test %>% select(-capture_rate))
